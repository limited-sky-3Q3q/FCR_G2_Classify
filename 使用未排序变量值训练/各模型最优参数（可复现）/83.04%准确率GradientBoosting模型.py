...
print("="*80)
print("Gradient Boosting模型 - 83.04%准确率")
print("="*80)
...
# 4. 配置Gradient Boosting (调优后最优)
print("\n【4. 配置Gradient Boosting】")
print("最优参数:")
...
scores = cross_val_score(gb, X_scaled, y, cv=skf, scoring='accuracy')
...
print(f"参数: n_estimators=50, lr=0.05, max_depth=3, subsample=1.0")
