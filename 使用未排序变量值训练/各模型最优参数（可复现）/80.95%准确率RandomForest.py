...
print("="*80)
print("Random Forest模型 - 80.95%准确率")
print("="*80)
...
scores = cross_val_score(rf, X_scaled, y, cv=skf, scoring='accuracy')
...
print(f"\n模型: Random Forest")
print(f"参数: n_estimators=100, max_depth=None, min_samples_split=7")
