...
scores = cross_val_score(et, X_scaled, y, cv=skf, scoring='accuracy')
...
print(f"\n模型: Extra Trees")
print(f"参数: n_estimators=100, max_depth=None, max_features='sqrt'")
