# -*- coding: utf-8 -*-
"""
Neural Network (MLP)模型 - 87.20%准确率
...
print("="*80)
print("Neural Network (MLP)模型 - 87.20%准确率")
print("="*80)
...
scores = cross_val_score(mlp, X_scaled, y, cv=skf, scoring='accuracy')
...
print(f"\n模型: MLP (Neural Network)")
print(f"参数: hidden=(100,50), activation='tanh', alpha=0.1, lr=0.1, max_iter=500")
